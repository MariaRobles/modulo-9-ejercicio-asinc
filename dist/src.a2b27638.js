...
function getQuotes() {
  return fetch("https://breakingbadapi.com/api/quotes").then(function (response) {
...
var getCharacters = require("./data-business");

var CharacterRow = require("./utils");

var character = require("./utils");

var getQuotes = require("./data-business"); //const listQuote = require("./utils"); 


//getCharacters.getCharacters();
//getQuotes.getQuotes();
getCharacters.getCharacters().then(function (data) {
  var characters = data;
  var nodes = [];
  ...
  try {
    var _loop = function _loop() {
      ...
      var node = CharacterRow.createCharacterRow(user);
...
getQuotes.getQuotes().then(function (data) {
  console.log(data);
});
},{"./data-business":"src/data-business.js","./utils":"src/utils.js","./styles.css":"src/styles.css"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
